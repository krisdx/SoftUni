                        ...
                        <div class="card-group">
                            <div class="card col-4 thumbnail">
                                ...
                                <div class="card-footer">
                                    <a class="card-button btn btn-warning" name="edit" href="/games/edit/${game.getId()}">Edit</a>
                                    <a class="card-button btn btn-danger" name="delete" href="/games/delete/${game.getId()}">Delete</a>

                                    <a class="card-button btn btn-outline-primary" name="info" href="/games/info/${game.getId()}">Info</a>
                                    <a class="card-button btn btn-primary" name="buy" href="/games/buy/${game.getId()}">Buy</a>
                                </div>
                            </div>
                        </div>
                    </c:forEach>
