...
@CommandName(name = "Revision")
public class RevisionCommand extends Command implements Executable {

    public RevisionCommand(Engine engine) {
        super(engine);
    }
    ...
    public void execute(String[] args) {
        ...
        int revision = classInfoAnnotation.revision();
        this.getEngine().getWriter().printLine("Revision: " + Integer.toString(revision));
    }
}